...
public class MessagingSystemForm extends JPanel {
    ...
    public MessagingSystemForm(String teacherUsername) {
        ...
        studentDropdown.addItemListener(e -> {
    ...
    private void loadStudents() {
        try (Connection conn = Database.getConnection()) {
            ResultSet rs = conn.createStatement().executeQuery("SELECT name, roll FROM students");
            while (rs.next()) {
                String name = rs.getString("name");
                String roll = rs.getString("roll");
                studentDropdown.addItem(name + " - " + roll);
            }
    ...
    private String getSelectedStudentRoll() {
    ...
    private void loadMessages() {
        String studentRoll = getSelectedStudentRoll();
        chatPanel.removeAll();
        ...
        try (Connection conn = Database.getConnection()) {
            ...
            while (rs.next()) {
                ...
                JPanel msgWrapper = new JPanel(new FlowLayout(sender.equals(teacherUsername) ? FlowLayout.RIGHT : FlowLayout.LEFT));
                msgWrapper.setBackground(Color.WHITE);

                if (sender.equals(teacherUsername)) {
